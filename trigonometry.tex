...
\usepackage[b5paper, total={5in, 7.8in}]{geometry}
...
\usepackage{xcolor, calc, graphicx, soul, float, makeidx, pgfplots,
...
\date{}
%\titlepic{\includegraphics{cover1.pdf}}
\titleformat{\section}
...
\include{trigonometric-identities}
\include{properties-of-triangle}
\include{inverse-circular-functions}
\part{Solutions}
\backmatter
\include{fdl}
\printindex
